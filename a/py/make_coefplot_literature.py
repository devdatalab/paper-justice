...
df.loc[df.name == 'Table 4-gender', 'name'] = 'Gender bias in this paper (India N=5155378)'
df.loc[df.name == 'Table 5-religion', 'name'] = 'Religion bias in this paper (India N=5240140)'

# drop all Ash rows from this study except the first two
df.drop(df[df.study.str.contains(r'ash-[c-h]')].index, inplace=True)
