...
for p in ax.patches:
    ...
    if p.get_width() > 1:
        ax.annotate(note, (p.get_width() + 0.05, p.get_y()+.2), fontsize=26, fontweight="normal", color="black")
    else:
        ax.annotate(note, (p.get_width() - 0.2, p.get_y()+.15), fontsize=26, fontweight="normal", color="black")
