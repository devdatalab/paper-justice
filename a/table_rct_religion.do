/* billy write $out/religion_acquitted.tex */
/* billy write $out/religion_decision.tex */
/* billy write $out/religion_acquitted_high_match.tex */
/* billy write $out/religion_acquitted_amb.tex */
/* billy write $out/religion_non_convicted.tex */
/* billy ignore all */
...
table_from_tpl, t($jcode/tex/r_tplA.tex) r($tmp/religion_acquitted.csv) o($out/religion_acquitted.tex)
...
/* write regression table */
table_from_tpl, t($jcode/tex/r_tplB.tex) r($tmp/religion_decision.csv) o($out/religion_decision.tex)
...
table_from_tpl, t($jcode/tex/r_tpl.tex) r($tmp/religion_non_convicted.csv) o($out/religion_non_convicted.tex)
...
table_from_tpl, t($jcode/tex/r_tpl.tex) r($tmp/religion_acquitted.csv) o($out/religion_acquitted_amb.tex)
...
table_from_tpl, t($jcode/tex/r_tpl.tex) r($tmp/religion_acquitted.csv) o($out/religion_acquitted_high_match.tex)
