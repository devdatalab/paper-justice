...
store_paper_stat `rb_cm' using $out/justice_paper_stats.csv, description("Religion bias acquittal - court-month: coef") group("main bias results")  

/* store sample */
store_paper_stat `rb_cm_n' using $out/justice_paper_stats.csv, description("Religion bias acquittal - court-month: sample") group("main bias results")  
...
store_paper_stat `rb_cy' using $out/justice_paper_stats.csv, description("Religion bias acquittal - court-year: coef") group("main bias results")  

/* store sample from column 6 in stats csv */
store_paper_stat `rb_cy_n' using $out/justice_paper_stats.csv, description("Religion bias acquittal - court-year: sample") group("main bias results")  
...
store_paper_stat `rb_cm' using $out/justice_paper_stats.csv, description("Religion bias decision - court-month: coef") group("main bias results")  

/* write sample from col 3 in stats csv */
store_paper_stat `rb_cm_n' using $out/justice_paper_stats.csv, description("Religion bias decision - court-month: sample") group("main bias results")  
...
store_paper_stat `rb_cy' using $out/justice_paper_stats.csv, description("Religion bias decision - court-year: coef") group("main bias results")  

/* store sample from col 6 in stats csv */
store_paper_stat `rb_cy_n' using $out/justice_paper_stats.csv, description("Religion bias decision - court-year: sample") group("main bias results")  
