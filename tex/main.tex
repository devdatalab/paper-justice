...
\begin{center}
  ...
  \input{./exhibits/outcome_variable_coding.tex}
...
\begin{table}
    \begin{center}
      ...
      \label{tab:balance}
     \input{./exhibits/randomization_combined}
     \begin{minipage}{0.95\textwidth}
...
\begin{sidewaystable}
    \begin{center}
        ...
        \vspace{2mm}
        \input{./exhibits/gender_decision}
    \end{center}
...
\begin{sidewaystable}
    \begin{center}
        ...
        \vspace{2mm}
        \input{./exhibits/religion_decision}
    \end{center}
  ...
  \begin{table}%[ht]
    \begin{center}
      ...
      \label{tab:victim_inter}
        \input{./exhibits/victim_inter.tex}
...
\begin{table}
  ...
  \label{tab:training}
  \input{./exhibits/training_dist.tex}
  \end{center}
   \begin{minipage}{1.0\textwidth}
...
\begin{table}
  \begin{center}
     ...
     \input{./exhibits/gender_acquitted_amb}
    \end{center}
    \begin{minipage}{1.6\textwidth}
        \footnotesize 
        \emph{Notes:} Standard errors in parentheses. \sym{*} \(p<0.10\), \sym{**} \(p<0.05\), \sym{***} \(p<0.01\).  \par 
...
\begin{table}
  \begin{center}
     ...
     \input{./exhibits/religion_non_convicted}
    \end{center}
    \begin{minipage}{1.6\textwidth}
        \footnotesize 
        \emph{Notes:} Standard errors in parentheses. \sym{*} \(p<0.10\), \sym{**} \(p<0.05\), \sym{***} \(p<0.01\).  \par 
...
\begin{table}
  \begin{center}
     ...
     \input{./exhibits/religion_acquitted_amb}
    \end{center}
    \begin{minipage}{1.6\textwidth}
        \footnotesize 
        \emph{Notes:} Standard errors in parentheses. \sym{*} \(p<0.10\), \sym{**} \(p<0.05\), \sym{***} \(p<0.01\).  \par 
...
\begin{table}[ht!]
      \begin{center}
        ...
        \input{./exhibits/gender_acquitted_wom}
      \end{center}
    \begin{minipage}{1.6\textwidth}
        \footnotesize 
        \emph{Notes:} Standard errors in parentheses. \sym{*} \(p<0.10\), \sym{**} \(p<0.05\), \sym{***} \(p<0.01\).  \par 
